...
const phoneMasks = {
    af: { n: "Afghanistan (افغانستان)", c: "+93", m: "99-999-9999" },
    al: { n: "Albania (Shqipëri)", c: "+355", m: "(999) 999-999" },
    dz: { n: "Algeria (الجزائر)", c: "+213", m: "99-999-9999" },
    ad: { n: "Andorra", c: "+376", m: "999-999" },
    ao: { n: "Angola", c: "+244", m: "(999) 999-999" },
    am: { n: "Armenia (Հայաստան)", c: "+374", m: "99-999-999" },
    ag: { n: "Antigua and Barbuda", c: "+1 (268)", m: "(268)999-9999" },
    ar: { n: "Argentina", c: "+54", m: "(999) 9999-9999" },
    au: { n: "Australia", c: "+61", m: "99-9999-9999" },
    at: { n: "Austria (Österreich)", c: "+43", m: "(999) 999-99999" },
    az: { n: "Azerbaijan (Azərbaycan)", c: "+994", m: "99-999-99-99" },
    bs: { n: "Bahamas", c: "+1 (242)", m: "+999-9999" },
    bh: { n: "Bahrain (البحرين)", c: "+973", m: "9999-9999" },
    bd: { n: "Bangladesh (বাংলাদেশ)", c: "+880", m: "9999-999999" },
    bb: { n: "Barbados", c: "+1 (246)", m: "999-9999" },
    by: { n: "Belarus (Беларусь)", c: "+375", m: "(99) 999-99-99" },
    be: { n: "Belgium (België)", c: "+32", m: "(999) 999-999" },
    bz: { n: "Belize", c: "+501", m: "999-9999" },
    bj: { n: "Benin (Bénin)", c: "+229", m: "99-99-9999" },
    bt: { n: "Bhutan (འབྲུག)", c: "+975", m: "9-999-9999" },
    bo: { n: "Bolivia", c: "+591", m: "9-999-9999" },
    ba: { n: "Bosnia and Herzegovina", c: "+387", m: "99-999-999" },
    bw: { n: "Botswana", c: "+267", m: "99-999-999" },
    br: { n: "Brazil (Brasil)", c: "+55", m: "(99) 99999-9999" },
    bn: { n: "Brunei", c: "+673", m: "999-9999" },
    bg: { n: "Bulgaria (България)", c: "+359", m: "(999) 999-999" },
    bf: { n: "Burkina Faso", c: "+226", m: "99-99-9999" },
    bi: { n: "Burundi (Uburundi)", c: "+257", m: "99-99-9999" },
    kh: { n: "Cambodia (កម្ពុជា)", c: "+855", m: "99-999-999" },
    cm: { n: "Cameroon (Cameroun)", c: "+237", m: "9-99-99-99-99" },
    ca: { n: "Canada", c: "+1", m: "(999) 999-9999" },
    cv: { n: "Cape Verde (Kabu Verdi)", c: "+238", m: "(999) 99-99" },
    cf: { n: "Central African Republic (République centrafricaine)", c: "+236", m: "99-99-9999" },
    td: { n: "Chad (Tchad)", c: "+235", m: "99-99-99-99" },
    cl: { n: "Chile", c: "+56", m: "9-9999-9999" },
    cn: { n: "China (中国)", c: "+86", m: "(999) 9999-9999" },
    co: { n: "Colombia", c: "+57", m: "(999) 999-9999" },
    km: { n: "Comoros (جزر القمر)", c: "+269", m: "99-99999" },
    cd: { n: "Congo (DRC) (Jamhuri ya Kidemokrasia ya Kongo)", c: "+243", m: "(999) 999-999" },
    cg: { n: "Congo (Republic) (Congo-Brazzaville)", c: "+242", m: "99-999-9999" },
    ck: { n: "Cook Islands", c: "+682", m: "99-999" },
    cr: { n: "Costa Rica", c: "+506", m: "9999-9999" },
    ci: { n: "Cote d’Ivoire", c: "+225", m: "99-999-999" },
    hr: { n: "Croatia (Hrvatska)", c: "+385", m: "99-999-9999" },
    cu: { n: "Cuba", c: "+53", m: "9-999-9999" },
    cy: { n: "Cyprus (Κύπρος)", c: "+357", m: "99-999-999" },
    cz: { n: "Czech Republic (Česká republika)", c: "+420", m: "(999) 999-999" },
    dk: { n: "Denmark (Danmark)", c: "+45", m: "99-99-99-99" },
    dj: { n: "Djibouti", c: "+253", m: "99-99-99-99" },
    dm: { n: "Dominica", c: "+1 (767)", m: "(767)999-9999" },
    do: { n: "Dominican Republic (República Dominicana)", c: "+1", m: "(999) 999-9999" },
    ec: { n: "Ecuador", c: "+593", m: "99-999-9999" },
    eg: { n: "Egypt (مصر)", c: "+20", m: "(999) 999-9999" },
    sv: { n: "El Salvador", c: "+503", m: "99-99-9999" },
    gq: { n: "Equatorial Guinea (Guinea Ecuatorial)", c: "+240", m: "99-999-9999" },
    er: { n: "Eritrea", c: "+291", m: "9-999-999" },
    ee: { n: "Estonia (Eesti)", c: "+372", m: "9999-9999" },
    et: { n: "Ethiopia", c: "+251", m: "99-999-9999" },
    fj: { n: "Fiji", c: "+679", m: "999-9999" },
    fi: { n: "Finland (Suomi)", c: "+358", m: "999-9999999" },
    fr: { n: "France", c: "+33", m: "(999) 999-9999" },
    ga: { n: "Gabon", c: "+241", m: "9-99-99-99" },
    gm: { n: "Gambia", c: "+220", m: "(999) 99-99" },
    ge: { n: "Georgia (საქართველო)", c: "+995", m: "(999) 999-999" },
    de: { n: "Germany (Deutschland)", c: "+49", m: "(999) 999-99999" },
    gh: { n: "Ghana (Gaana)", c: "+233", m: "(999) 999-999" },
    gr: { n: "Greece (Ελλάδα)", c: "+30", m: "(999) 999-9999" },
    gd: { n: "Grenada", c: "+1 (473)", m: "999-9999" },
    gt: { n: "Guatemala", c: "+502", m: "9-999-9999" },
    gn: { n: "Guinea (Guinée)", c: "+224", m: "999-99-99-99" },
    gw: { n: "Guinea-Bissau (Guiné Bissau)", c: "+245", m: "9-999999" },
    gy: { n: "Guyana", c: "+592", m: "999-9999" },
    ht: { n: "Haiti", c: "+509", m: "99-99-9999" },
    hn: { n: "Honduras", c: "+504", m: "9999-9999" },
    hk: { n: "Hong Kong (香港)", c: "+852", m: "9999-9999" },
    hu: { n: "Hungary (Magyarország)", c: "+36", m: "(999) 999-999" },
    is: { n: "Iceland (Ísland)", c: "+354", m: "999-9999" },
    in: { n: "India (भारत)", c: "+91", m: "(9999) 999-999" },
    id: { n: "Indonesia", c: "+62", m: "(999) 999-99-9999" },
    ir: { n: "Iran (ایران)", c: "+98", m: "(999) 999-9999" },
    iq: { n: "Iraq (العراق)", c: "+964", m: "(999) 999-9999" },
    ie: { n: "Ireland", c: "+353", m: "(999) 999-999" },
    il: { n: "Israel (ישראל)", c: "+972", m: "999-999-9999" },
    it: { n: "Italy (Italia)", c: "+39", m: "(999) 9999-999" },
    jm: { n: "Jamaica", c: "+1", m: "(999) 999-9999" },
    jp: { n: "Japan (日本)", c: "+81", m: "99-9999-9999" },
    jo: { n: "Jordan (الأردن)", c: "+962", m: "9-9999-9999" },
    kz: { n: "Kazakhstan (Казахстан)", c: "+7", m: "(999) 999-99-99" },
    ke: { n: "Kenya", c: "+254", m: "999-999999" },
    ki: { n: "Kiribati", c: "+686", m: "99-999" },
    xk: { n: "Kosovo (Republic)", c: "+383", m: "99-999-999" },
    kw: { n: "Kuwait (الكويت)", c: "+965", m: "9999-9999" },
    kg: { n: "Kyrgyzstan (Кыргызстан)", c: "+996", m: "(999) 999-999" },
    la: { n: "Laos (ລາວ)", c: "+856", m: "99-999-999" },
    lv: { n: "Latvia (Latvija)", c: "+371", m: "99-999-999" },
    lb: { n: "Lebanon (لبنان)", c: "+961", m: "99-999-999" },
    ls: { n: "Lesotho", c: "+266", m: "9-999-9999" },
    lr: { n: "Liberia", c: "+231", m: "99-999-9999" },
    ly: { n: "Libya (ليبيا)", c: "+218", m: "99-999-999" },
    li: { n: "Liechtenstein", c: "+423", m: "999-99-99" },
    lt: { n: "Lithuania (Lietuva)", c: "+370", m: "(999) 99-999" },
    lu: { n: "Luxembourg", c: "+352", m: "(999) 999-999" },
    mo: { n: "Macao", c: "+853", m: "9999-9999" },
    mk: { n: "Macedonia (FYROM) (Македонија)", c: "+389", m: "99-999-999" },
    mg: { n: "Madagascar (Madagasikara)", c: "+261", m: "99-99-99999" },
    mw: { n: "Malawi", c: "+265", m: "9-9999-9999" },
    my: { n: "Malaysia", c: "+60", m: "99-9999-9999" },
    mv: { n: "Maldives", c: "+960", m: "999-9999" },
    ml: { n: "Mali", c: "+223", m: "+99-99-9999" },
    mt: { n: "Malta", c: "+356", m: "9999-9999" },
    mh: { n: "Marshall Islands", c: "+692", m: "999-9999" },
    mr: { n: "Mauritania (موريتانيا)", c: "+222", m: "99-99-9999" },
    mu: { n: "Mauritius (Moris)", c: "+230", m: "999-99999" },
    mx: { n: "Mexico (México)", c: "+52", m: "(999) 999-9999" },
    mb: { n: "Mexico (México)", c: "+521", m: "(999) 999-9999" },
    fm: { n: "Micronesia", c: "+691", m: "999-9999" },
    md: { n: "Moldova (Republica Moldova)", c: "+373", m: "9999-9999" },
    mc: { n: "Monaco", c: "+377", m: "99-999-999" },
    mn: { n: "Mongolia (Монгол)", c: "+976", m: "99-99-9999" },
    me: { n: "Montenegro (Crna Gora)", c: "+382", m: "99-999-999" },
    ma: { n: "Morocco (المغرب)", c: "+212", m: "99-9999-999" },
    mz: { n: "Mozambique (Moçambique)", c: "+258", m: "99-999-999" },
    mm: { n: "Myanmar (Burma) (မြန်မာ)", c: "+95", m: "99-999-999" },
    na: { n: "Namibia (Namibië)", c: "+264", m: "99-999-9999" },
    nr: { n: "Nauru", c: "+674", m: "999-9999" },
    np: { n: "Nepal (नेपाल)", c: "+977", m: "999-999-9999" },
    nl: { n: "Netherlands (Nederland)", c: "+31", m: "99-999-9999" },
    nz: { n: "New Zealand", c: "+64", m: "(999) 999-999" },
    ni: { n: "Nicaragua", c: "+505", m: "9999-9999" },
    ne: { n: "Niger (Nijar)", c: "+227", m: "99-99-9999" },
    ng: { n: "Nigeria", c: "+234", m: "999-999-9999" },
    nu: { n: "Niue", c: "+683", m: "9999" },
    kp: { n: "North Korea (조선 민주주의 인민 공화국)", c: "+850", m: "99-999-999" },
    no: { n: "Norway (Norge)", c: "+47", m: "(999) 99-999" },
    om: { n: "Oman (عُمان)", c: "+968", m: "99-999-999" },
    pa: { n: "Panama", c: "+507", m: "9999-9999" },
    pk: { n: "Pakistan (پاکستان)", c: "+92", m: "(999) 999-9999" },
    pw: { n: "Palau", c: "+680", m: "999-9999" },
    ps: { n: "Palestinian Territory", c: "+970", m: "99 999 9999" },
    pg: { n: "Papua New Guinea", c: "+675", m: "(999) 99-999" },
    py: { n: "Paraguay", c: "+595", m: "(999) 999-999" },
    pe: { n: "Peru (Perú)", c: "+51", m: "(999) 999-999" },
    ph: { n: "Philippines", c: "+63", m: "(999) 999-9999" },
    pl: { n: "Poland (Polska)", c: "+48", m: "(999) 999-999" },
    pt: { n: "Portugal", c: "+351", m: "99-999-9999" },
    qa: { n: "Qatar (قطر)", c: "+974", m: "9999-9999" },
    ro: { n: "Romania (România)", c: "+40", m: "99-999-9999" },
    ru: { n: "Russian Federation (Российская Федерация)", c: "+7", m: "(999) 999-99-99" },
    rw: { n: "Rwanda", c: "+250", m: "(999) 999-999" },
    kn: { n: "Saint Kitts and Nevis", c: "+1 (869)", m: "999-9999" },
    lc: { n: "Saint Lucia", c: "+1 (758)", m: "999-9999" },
    vc: { n: "Saint Vincent and the Grenadines", c: "+1 (784)", m: "999-9999" },
    ws: { n: "Samoa", c: "+685", m: "99-9999" },
    sm: { n: "San Marino", c: "+378", m: "9999-999999" },
    st: { n: "Sao Tome and Principe (São Tomé e Príncipe)", c: "+239", m: "99-99999" },
    sa: { n: "Saudi Arabia (المملكة العربية السعودية)", c: "+966", m: "9-9999-9999" },
    sn: { n: "Senegal (Sénégal)", c: "+221", m: "99-999-9999" },
    rs: { n: "Serbia (Србија)", c: "+381", m: "99-999-9999" },
    sc: { n: "Seychelles", c: "+248", m: "9-999-999" },
    sl: { n: "Sierra Leone", c: "+232", m: "99-999999" },
    sg: { n: "Singapore", c: "+65", m: "9999-9999" },
    sk: { n: "Slovakia (Slovensko)", c: "+421", m: "(999) 999-999" },
    si: { n: "Slovenia (Slovenija)", c: "+386", m: "99-999-999" },
    sb: { n: "Solomon Islands", c: "+677", m: "999-9999" },
    so: { n: "Somalia (Soomaaliya)", c: "+252", m: "99-999-999" },
    za: { n: "South Africa", c: "+27", m: "99-999-9999" },
    kr: { n: "South Korea (대한민국)", c: "+82", m: "99-9999-9999" },
    ss: { n: "South Sudan (جنوب السودان)", c: "+211", m: "99-999-9999" },
    es: { n: "Spain (España)", c: "+34", m: "(999) 999-999" },
    lk: { n: "Sri Lanka (ශ්‍රී ලංකාව)", c: "+94", m: "99-999-9999" },
    sd: { n: "Sudan (السودان)", c: "+249", m: "99-999-9999" },
    sr: { n: "Suriname", c: "+597", m: "999-9999" },
    sz: { n: "Swaziland", c: "+268", m: "99-99-9999" },
    se: { n: "Sweden (Sverige)", c: "+46", m: "99-999-9999" },
    ch: { n: "Switzerland (Schweiz)", c: "+41", m: "99-999-9999" },
    sy: { n: "Syria (سوريا)", c: "+963", m: "99-9999-999" },
    tw: { n: "Taiwan (台灣)", c: "+886", m: "9999-9999" },
    tj: { n: "Tajikistan", c: "+992", m: "99-999-9999" },
    tz: { n: "Tanzania", c: "+255", m: "99-999-9999" },
    th: { n: "Thailand (ไทย)", c: "+66", m: "99-999-9999" },
    tg: { n: "Togo", c: "+228", m: "99-999-999" },
    to: { n: "Tonga", c: "+676", m: "99999" },
    tt: { n: "Trinidad and Tobago", c: "+1 (868)", m: "999-9999" },
    tn: { n: "Tunisia (تونس)", c: "+216", m: "99-999-999" },
    tr: { n: "Turkey (Türkiye)", c: "+90", m: "(999) 999-99999" },
    tm: { n: "Turkmenistan", c: "+993", m: "9-999-9999" },
    tv: { n: "Tuvalu", c: "+688", m: "999999" },
    ug: { n: "Uganda", c: "+256", m: "(999) 999-999" },
    ua: { n: "Ukraine (Україна)", c: "+380", m: "(99) 999-99-99" },
    ae: { n: "United Arab Emirates (الإمارات العربية المتحدة)", c: "+971", m: "99-999-9999" },
    gb: { n: "United Kingdom", c: "+44", m: "99-9999-99999" },
    us: { n: "USA", c: "+1", m: "(999) 999-9999" },
    uy: { n: "Uruguay", c: "+598", m: "9-999-99-99" },
    uz: { n: "Uzbekistan (Oʻzbekiston)", c: "+998", m: "99-999-9999" },
    vu: { n: "Vanuatu", c: "+678", m: "99-99999" },
    va: { n: "Vatican City (Città del Vaticano)", c: "+39", m: "9-999-99999" },
    ve: { n: "Venezuela", c: "+58", m: "(999) 999-9999" },
    vn: { n: "Vietnam (Việt Nam)", c: "+84", m: "99-9999-999" },
    ye: { n: "Yemen (اليمن)", c: "+967", m: "9-999-999" },
    zm: { n: "Zambia", c: "+260", m: "99-999-9999" },
    zw: { n: "Zimbabwe", c: "+263", m: "9-999999" },
};
...
phoneInputs.forEach(input => {
    window.intlTelInput(input, {
        ...
        nationalMode: true // отключение маски для placeholder
    });
    ...
    input.addEventListener("countrychange", function() {
        ...
        const selectedCountryIso2 = selectedCountryData.iso2;
        
        console.log("Выбрана страна:", phoneMasks[selectedCountryIso2]);
