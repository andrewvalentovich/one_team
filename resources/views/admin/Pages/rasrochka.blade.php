        ...
        <div class="col-12 grid-margin stretch-card" bis_skin_checked="1">
            ...
            <div class="card" bis_skin_checked="1" style="min-height: 1000px">
                ...
                <div class="card-body" bis_skin_checked="1">
                    ...
                    @endif
                    <h4 class="card-title">Рассрочка</h4>
                    <form class="forms-sample" action="{{route('rasrochka_page_create')}}" method="post" enctype="multipart/form-data">
                        @csrf
...
{{--                        <textarea id="mytextarea" name="invest_editor"></textarea>--}}
                        <br>
                        <br>
