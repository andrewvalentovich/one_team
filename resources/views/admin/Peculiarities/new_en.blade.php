        ...
        <div class="col-12 grid-margin stretch-card" bis_skin_checked="1">
            ...
            <div class="card" bis_skin_checked="1" style="min-height: 1000px">
                ...
                <div class="card-body" bis_skin_checked="1">
                    ...
                    @endif
                    <h4 class="card-title">Добавление {{$string}} на Английском</h4>
                    <form class="forms-sample" action="{{route('create_peculiarities_en')}}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group" bis_skin_checked="1">
                            <label for="exampleInputName1">Название в url (slug) (необязательное поле)</label>
