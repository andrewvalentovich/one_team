...
@section('title')
    {{__("Редактирование категории для фото")}}
@endsection
        ...
        <div class="col-12 grid-margin stretch-card" bis_skin_checked="1">
            <div class="card" bis_skin_checked="1" style="min-height: 1000px">
                <div class="card-body" bis_skin_checked="1">
                    ...
                    @endif
                    <h4 class="card-title">{{ __('Редактирование категории') }}</h4>
                    <form class="forms-sample" action="{{ route('admin.photo_categories.update', $photo_category->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
