                        ...
                        <div class="city-col__list">
                           ...
                           <g id="Слой_x0020_1">
                               ...
                               <polyline class="fil0 str0" points="0.46,0.04 0.07,0.43 0.46,0.82 "/>
                                                    ...
                                                    <?php  $get = \App\Models\favorite::where('user_id', isset($_COOKIE['user_id']) ? $_COOKIE['user_id'] : null)->where('product_id', $product->id)->first() ?>
                                                    <div
                                                        class="place__header-favorite check-favorites {{ $get == null ? '' : 'active' }}"
                                                        data_id="{{$product->id}}">
                                            ...
                                            <div class="place__content">
                                                    ...
                                                    <div class="place__left-content">
                                                        <div class="place__left-top">
                                                            <div class="place__top-img place__collage-item_clickable">
                                                                <img
                                                                    src="{{asset('uploads/'.$product->photo[0]->photo)}}"
                                                                    alt="object">
                                                            </div>
                                                        </div>
                                                        <div class="place__left-collage">
                                                            @foreach($product->photo->where('id','!=',$product->photo[0]->id) as $photo)
                                                                <div
                                                                    class="place__collage-item place__collage-item_clickable">
                                                    ...
                                                    <div class="place__slider">
                                                        <div class="place__swiper swiper">
                                                            <div class="place__wrapper swiper-wrapper">
                                                                @foreach($product->photo as $photo)
                                                                    <div
                                                                        class="place__slide swiper-slide place__slide_clickable">
                                                                        <img src="{{asset('uploads/'.$photo->photo)}}"
                                                                             alt="object">
                                                                    </div>
                                                                @endforeach
                                                ...
                                                <div class="place__right-col">
                                                    ...
                                                    <div class="place__right-top">
                                                        ...
                                                        <?php  $get = \App\Models\favorite::where('user_id', isset($_COOKIE['user_id']) ? $_COOKIE['user_id'] : null)->where('product_id', $product->id)->first() ?>
                                                        <div
                                                            class="place__top-favorites check-favorites {{ $get == null ? '' : 'active' }}"
                                                            data_id="{{$product->id}}">
                                                        ...
                                                        <div class="place__info">
                                                            <div class="place__price">
                                                                <div class="place__price-value">
                                                                    <div class="place__exchange-EUR">
                                                                        <span>{{ number_format($product->price, 0, '.', ' ') }}</span><b>
                                                                            €</b></div>
                                                                    <div class="place__exchange-USD"
                                                                         style="display: none;">
                                                                        <span>{{ number_format(intval($product->price * $exchanges['USD']), 0, '.', ' ') }}</span><b>
                                                                            $</b></div>
                                                                    <div class="place__exchange-RUB"
                                                                         style="display: none;">
                                                                        <span>{{ number_format(intval($product->price * $exchanges['RUB']), 0, '.', ' ') }}</span><b>
                                                                            ₽</b></div>
                                                                    <div class="place__exchange-TRY"
                                                                         style="display: none;">
                                                                        <span>{{ number_format(intval($product->price * $exchanges['TRY']), 0, '.', ' ') }}</span><b
                                                                            class="lira"> ₺</b></div>
                                                                </div>
                                                            ...
                                                            <div class="place__square">
                                                                <div
                                                                    class="place__square-EUR">{{ number_format(intval((int)$product->price / ((int)$product->size ?: 1)), 0, '.', ' ') }}
                                                                    € / кв.м
                                                                </div>
                                                                <div class="place__square-USD"
                                                                     style="display: none;">{{ number_format(intval((int)$product->price * $exchanges['USD'] / ((int)$product->size ?: 1)), 0, '.', ' ') }}
                                                                    $ / кв.м
                                                                </div>
                                                                <div class="place__square-RUB"
                                                                     style="display: none;">{{ number_format(intval((int)$product->price * $exchanges['RUB'] / ((int)$product->size ?: 1)), 0, '.', ' ') }}
                                                                    ₽ / кв.м
                                                                </div>
                                                                <div class="place__square-TRY"
                                                                     style="display: none;">{{ number_format(intval((int)$product->price * $exchanges['TRY'] / ((int)$product->size ?: 1)), 0, '.', ' ') }}
                                                                    <span class="lira"> ₺ </span> / кв.м
                                                                </div>
                                                            </div>
                                           ...
                                           <line class="fil0 str0" x1="1.06" y1="1.03" x2="0.9" y2="1.03"/>
                                                        ...
                                                        <div class="place__scroll-content">
                                                            ...
                                                            <div class="place__advantages">
                                                                ...
                                                                @if($product->vnj == 'Да')
                                                                    ...
                                                                    <div class="place__advantages-item">
                                                                        ...
                                                                        <div class="place__advantages-img">
                                                                            ...
                                                                            <svg width="71" height="57"
                                                                                 viewBox="0 0 71 57" fill="none"
                                                                                 xmlns="http://www.w3.org/2000/svg">
                                                                                ...
                                                                                <g clip-path="url(#clip0_890_2)">
                                                                                    ...
                                                                                    <path fill-rule="evenodd"
                                                                                          clip-rule="evenodd"
                                                                                          d="M28.0208 7.95917V37.8774H8.03809V7.95917H28.0208Z"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="4.01887"
                                                                                          stroke-miterlimit="22.9256"></path>

                                                                                    <path
                                                                                        d="M0 56.0739C4.1305 56.0739 4.80031 51.8318 8.81918 51.8318C12.9497 51.8318 13.6195 56.0739 17.75 56.0739C21.7689 56.0739 22.5503 51.8318 26.5692 51.8318C30.6997 51.8318 31.3695 56.0739 35.5 56.0739C39.5189 56.0739 40.3003 51.8318 44.3192 51.8318C48.4497 51.8318 49.1195 56.0739 53.25 56.0739C57.2689 56.0739 58.0503 51.8318 62.0692 51.8318C66.1997 51.8318 66.8695 56.0739 71 56.0739"
                                                                                        stroke="#508CFA"
                                                                                        stroke-width="2.00943"
                                                                                        stroke-miterlimit="22.9256"></path>

                                                                                    <path
                                                                                        d="M0 48.0362C4.1305 48.0362 4.80031 43.7941 8.81918 43.7941C12.9497 43.7941 13.6195 48.0362 17.75 48.0362C21.7689 48.0362 22.5503 43.7941 26.5692 43.7941C30.6997 43.7941 31.3695 48.0362 35.5 48.0362C39.5189 48.0362 40.3003 43.7941 44.3192 43.7941C48.4497 43.7941 49.1195 48.0362 53.25 48.0362C57.2689 48.0362 58.0503 43.7941 62.0692 43.7941C66.1997 43.7941 66.8695 48.0362 71 48.0362"
                                                                                        stroke="#508CFA"
                                                                                        stroke-width="2.00943"
                                                                                        stroke-miterlimit="22.9256"></path>

                                                                                    <path d="M71 37.8774H0"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="4.01887"
                                                                                          stroke-miterlimit="22.9256"></path>
                                                                                    ...
                                                                                    <path fill-rule="evenodd"
                                                                                          clip-rule="evenodd"
                                                                                          d="M43.9843 21.9136V37.8774H28.0205V21.9136H43.9843Z"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="4.01887"
                                                                                          stroke-miterlimit="22.9256"></path>

                                                                                    <path d="M58.9434 18.0063V37.8774"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="2.00943"
                                                                                          stroke-miterlimit="22.9256"></path>

                                                                                    <path
                                                                                        d="M58.943 18.118C63.3821 18.118 66.9807 14.5193 66.9807 10.0802C66.9807 5.6411 63.3821 2.04248 58.943 2.04248C54.5039 2.04248 50.9053 5.6411 50.9053 10.0802C50.9053 14.5193 54.5039 18.118 58.943 18.118Z"
                                                                                        stroke="#508CFA"
                                                                                        stroke-width="4.01887"
                                                                                        stroke-miterlimit="22.9256"></path>

                                                                                    <path d="M20.9873 15.9969H14.959"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="2.00943"
                                                                                          stroke-miterlimit="22.9256"></path>

                                                                                    <path d="M20.9873 24.0346H14.959"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="2.00943"
                                                                                          stroke-miterlimit="22.9256"></path>
                                                                        ...
                                                                        <div class="place__advantages-img">
                                                                            ...
                                                                            <svg width="28" height="28"
                                                                                ...
                                                                                <g clip-path="url(#clip0_890_23)">
                                                                                    ...
                                                                                    <path
                                                                                        d="M13.9252 26.9519C21.1196 26.9519 26.9519 21.1196 26.9519 13.9251C26.9519 6.73065 21.1196 0.898376 13.9252 0.898376C6.73071 0.898376 0.898438 6.73065 0.898438 13.9251C0.898438 21.1196 6.73071 26.9519 13.9252 26.9519Z"
                                                                                        stroke="#508CFA"
                                                                                        stroke-width="1.94652"
                                                                                        stroke-miterlimit="22.9256"></path>

                                                                                    <path d="M11.0801 4.79144V7.93583"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="1.94652"
                                                                                          stroke-miterlimit="22.9256"></path>

                                                                                    <path d="M10.4814 7.93579V19.9144"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="1.94652"
                                                                                          stroke-miterlimit="22.9256"></path>

                                                                                    <path
                                                                                        d="M9.13379 7.93579H15.2728C16.7702 7.93579 18.1177 9.28339 18.1177 10.9304C18.1177 12.5775 16.7702 13.9251 15.2728 13.9251H10.4814"
                                                                                        stroke="#508CFA"
                                                                                        stroke-width="1.94652"
                                                                                        stroke-miterlimit="22.9256"
                                                                                        stroke-linecap="square"></path>

                                                                                    <path d="M14.0752 4.79144V7.93583"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="1.94652"
                                                                                          stroke-miterlimit="22.9256"></path>

                                                                                    <path
                                                                                        d="M9.13379 19.9144H17.2193C18.8664 19.9144 20.0643 18.7166 20.0643 16.9198C20.0643 15.2727 18.8664 13.9251 17.2193 13.9251H10.4814"
                                                                                        stroke="#508CFA"
                                                                                        stroke-width="1.94652"
                                                                                        stroke-miterlimit="22.9256"
                                                                                        stroke-linecap="square"></path>

                                                                                    <path d="M11.0801 19.9144V23.0588"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="1.94652"
                                                                                          stroke-miterlimit="22.9256"></path>

                                                                                    <path d="M14.0752 19.9144V23.0588"
                                                                                          stroke="#508CFA"
                                                                                          stroke-width="1.94652"
                                                                                          stroke-miterlimit="22.9256"></path>
                                                                ...
                                                                @if($product->commissions == 'Да')
                                                                    ...
                                                                    <div class="place__advantages-item">
                                                                        ...
                                                                        <div
                                                                            class="place__advantages-img place__advantages-commission">
                                                                            ...
                                                                            <svg width="27" height="27"
                                                                                ...
                                                                                <path
                                                                                    d="M23.8947 2H4.05263C2.91899 2 2 2.91899 2 4.05263V23.8947C2 25.0284 2.91899 25.9474 4.05263 25.9474H23.8947C25.0284 25.9474 25.9474 25.0284 25.9474 23.8947V4.05263C25.9474 2.91899 25.0284 2 23.8947 2Z"
                                                                                    stroke="#508CFA"
                                                                                    stroke-width="2.05263"
                                                                                    stroke-miterlimit="22.9256"></path>

                                                                                <path
                                                                                    d="M20.9303 7.47369L7.24609 21.1579"
                                                                                    stroke="#508CFA"
                                                                                    stroke-width="2.05263"
                                                                                    stroke-miterlimit="22.9256"></path>

                                                                                <path
                                                                                    d="M12.0351 7.01752L7.01758 12.0351"
                                                                                    stroke="#508CFA"
                                                                                    stroke-width="2.05263"
                                                                                    stroke-miterlimit="22.9256"></path>

                                                                                <path
                                                                                    d="M7.01758 7.01752L12.0351 12.0351"
                                                                                    stroke="#508CFA"
                                                                                    stroke-width="2.05263"
                                                                                    stroke-miterlimit="22.9256"></path>

                                                                                <path
                                                                                    d="M21.1582 16.1404L16.1406 21.1579"
                                                                                    stroke="#508CFA"
                                                                                    stroke-width="2.05263"
                                                                                    stroke-miterlimit="22.9256"></path>

                                                                                <path
                                                                                    d="M16.1406 16.1404L21.1582 21.1579"
                                                                                    stroke="#508CFA"
                                                                                    stroke-width="2.05263"
                                                                                    stroke-miterlimit="22.9256"></path>
                                                                    ...
                                                                    <div class="place__advantages-item">
                                                                        ...
                                                                        <div class="place__advantages-img">
                                                                            ...
                                                                            <svg width="27" height="27"
                                                                                ...
                                                                                <path
                                                                                    d="M23.0804 1H2.9598C1.87743 1 1 1.87743 1 2.9598V23.0804C1 24.1628 1.87743 25.0402 2.9598 25.0402H23.0804C24.1628 25.0402 25.0402 24.1628 25.0402 23.0804V2.9598C25.0402 1.87743 24.1628 1 23.0804 1Z"
                                                                                    stroke="#508CFA"
                                                                                    stroke-width="1.9598"
                                                                                    stroke-miterlimit="22.9256"></path>

                                                                                <path d="M8.05566 6.48743V20.4673"
                                                                                      stroke="#508CFA"
                                                                                      stroke-width="1.9598"
                                                                                      stroke-miterlimit="22.9256"></path>

                                                                                <path
                                                                                    d="M8.05566 6.48743H14.1964C16.4175 6.48743 18.116 8.31657 18.116 10.5377C18.116 12.7588 16.4175 14.4573 14.1964 14.4573H8.05566"
                                                                                    stroke="#508CFA"
                                                                                    stroke-width="1.9598"
                                                                                    stroke-miterlimit="22.9256"
                                                                                    stroke-linecap="square"></path>
                                                                ...
                                                                <div class="place__order-content">
                                                                    ...
                                                                    <div class="place__order-text">
                                                                        ...
                                                                        <div class="place__order-info">
                                                                            ...
                                                                            <div
                                                                                class="place__order-title place__title">
                                                                    ...
                                                                    <div class="place__order-img">
                                                                        ...
                                                                        <img src="{{asset('project/img/woman.png')}}"
                                                                             alt="woman">
                                                            ...
                                                            <div class="place__location">
                                                                ...
                                                                <div class="place__location-map">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <div id="place-map{{$product->id}}"
                                                                             style="width: 100%; height: 165px;"></div>
                                                            ...
                                                            <div class="kompleks__layout" bis_skin_checked="1">
                                                                <div class="kompleks__layout-content"
                                                                     bis_skin_checked="1">
                                                                    <div class="kompleks__layout-title place__title"
                                                                         bis_skin_checked="1">
                                                                        Планировки квартир
                                                                    </div>
                                                                    <div class="kompleks__layout-list"
                                                                         bis_skin_checked="1">
                                                                        @if(!is_null(json_decode($product->objects)))
                                                                            @foreach(json_decode($product->objects) as $object)
                                                                                <div class="kompleks__layout-item"
                                                                                     bis_skin_checked="1">
                                                                                    <div class="kompleks__layout-info"
                                                                                         bis_skin_checked="1">
                                                                                        <div
                                                                                            class="kompleks__layout-option"
                                                                                            bis_skin_checked="1">
                                                                                            {{ $object->building }}
                                                                                        </div>
                                                                                        <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            bis_skin_checked="1">
                                                                                            $ {{ number_format(intval((int) $object->price / ((int) $object->size  ?: 1)), 0, '.', ' ') }}
                                                                                            / кв.м
                                                                                        </div>
                                                                                        <div
                                                                                            class="kompleks__layout-square"
                                                                                            bis_skin_checked="1">
                                                                                            {{ $object->size }}
                                                                                            <span>|</span> {{ $object->apartment_layout }}

                                                                                        </div>
                                                                                        <div
                                                                                            class="kompleks__layout-price-month"
                                                                                            bis_skin_checked="1">
                                                                                            $645 / мес.
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="kompleks__layout-scheme"
                                                                                         bis_skin_checked="1">
                                                                                        <div
                                                                                            class="kompleks__layout-img"
                                                                                            ...
                                                                                            @if(isset($object->apartment_layout_image))
                                                                                                <img
                                                                                                    ...
                                                                                                    src="{{ asset('uploads/'.$object->apartment_layout_image) }}"
                                                                                                    alt="scheme">
                                                                                            @else
                                                                                                <img
                                                                                                    data-objectid="{{ $object->id }}"
                                                                    ...
                                                                    <footer class="footer footer_place">
                                                                        <div class="footer__top">
                                                                            <a href="{{route('home_page')}}"
                                                                               class="footer__logo">
                                                                               <img
                                                                                   src="{{asset('project/img/svg/logo.svg')}}"
                                                                                   alt="logo">
                                                                            </a>
                                                                        </div>
                                                                        <div class="footer__nav">
                                                                            <div class="footer__nav-list">
                                                                                ...
                                                                                @foreach($get_footer_link as $link)
                                                                                    <a href="{{route('company_page',$link->id)}}"
                                                                        ...
                                                                        <div class="footer__content">
                                                                            <a href="{{route('personal_data_processing_policy')}}"
                                                                               class="footer__subtitle">
                                                                                {{__('Пользовательское соглашение при использовании сайта')}}
                                                                            </a>
                                                                            <a href="{{route('user_agreement_when_using_the_site')}}"
                                                                               class="footer__subtitle">
                                                                        ...
                                                                        <div class="footer__bottom">
                                                                            <div class="footer__slogan">
                                                                                © 2022
                                                                                - {{\Illuminate\Support\Carbon::now()->year}}
                                                                                OneTeam
                                                                            </div>
                                                                        </div>
                                                                    </footer>
...
//
            ...
            let g = document.querySelectorAll(".city-col__item"),
                ...
                b = document.querySelectorAll(".place-w");
            ...
            g.forEach((item, index) => {
                ...
                item.addEventListener('click', () => {
                    ...
                    if (
                        item.getAttribute('data_id') ==

                        b[index].getAttribute('data_id')
                    ) {
