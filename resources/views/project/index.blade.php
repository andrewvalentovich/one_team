    ...
    <section class="hello container">
        ...
        <div class="hello__content">
            ...
            <div class="hello__text">
                ...
                <div class="hello__text-lead">
                    <p>
                        {{ __('Офис агентства расположен в Анталье; зоны нашего особого интереса — это Манавгат, Кемер, Белек, Финике, Сиде, Алания, Махмутлар, Авсаллар, Каргыджак, Кестел. Также мы активно работаем и в других регионах Турецкой Республики, в частности, в Мерсине, Бодруме, Фетхие.') }}
                    </p>
                </div>
                <div class="hello__text-lead">
                    <p>
        ...
        <div class="advantages__content">
            <div class="advantages__item">
                ...
                <div class="advantages__item-text">
                    ...
                    <p>
                        {{ __('Мы не просто продаем недвижимость от застройщика в Турции, а имеем личные договоренности со строительными компаниями.') }}
                    </p>
                    <p>
                        {{ __('Это позволяет предлагать нашим клиентам специальные расценки, которые ниже, чем если бы вы приобретали напрямую у застройщика.') }}
                    </p>
                </div>
            </div>
            <div class="advantages__item">
                ...
                <div class="advantages__item-text">
                    ...
                    <p>
                        {{ __('Благодаря налаженному партнерству с турецкими банками Oneteam осуществляет продажу недвижимости в Турции в рассрочку, в ипотеку (кредит) под минимальные проценты.') }}
                    </p>
                    <p>
                        {{ __('Покупайте так, как вам удобно!') }}
                    </p>
                </div>
            </div>
            <div class="advantages__item">
                ...
                <div class="advantages__item-text">
                    <b>
                        {{ __('Полная безопасность') }}
                    </b>
                    <p>
                        {{ __('Все сделки заключаются в соответствии с турецким законодательством и с применением инструментов минимизации рисков, а мы отчитываемся перед вами по всем производимым операциям — в том числе и финансовым.') }}
                    </p>
                    <p>
                        {{ __('Приобретая недвижимость в Oneteam, вы ничем не рискуете.') }}
                    </p>
                </div>
            </div>
            <div class="advantages__item">
                ...
                <div class="advantages__item-text">
                    <b>
                        {{ __('Клиентоориентированность') }}
                    </b>
                    <p>
                        {{ __('Oneteam подготовит для вас пул доступных вариантов, предоставит переводчика и юриста, и обеспечит бережное сопровождение на каждом этапе сделки.') }}
                    </p>
                    <p>
                        {{ __('Мы знаем, что сориентироваться в рынке недвижимости другой страны сложно, и заботимся о том, чтобы процесс покупки прошел для вас максимально комфортно.') }}
                    </p>
                </div>
            </div>
        </div>
