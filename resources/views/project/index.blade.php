                ...
                <div class="popular-locations__list">
                    ...
                    <div class="popular-locations__item">
                        <div class="popular-locations__item-img">
                            <a href="{{route('country', $country->id)}}"> <img style="max-width: 50px" src="{{asset("uploads/$country->photo")}}" alt="gr"></a>
                        </div>
                        <div class="popular-locations__item-text">
                            ...
                            <a href="{{route('country', $country->id)}}">  {{$country->name}} <span>{{$country->product_country->count()}}</span></a>
                        </div>
                    </div>
                    @endforeach
                </div>
        ...
        <section class="contact">
            ...
            <div class="contact__form selection-phone">
                ...
                <div class="contact__form-phone">
                    ...
                    <input data-phone-pattern class="contact__form-phone-input contact__phone-input" placeholder="{{__('Ваш телефон')}} {{__('в')}} whatsApp" name="phone">
...
@endsection
    ...
    <script>
        ...
        async function getData() {
            ...
            // await fetch('http://localhost:8879/city_from_map')
