...
@section('seo')
<title>{{ __('Лучшие объекты недвижимости в Алании и Турции от агентства Oneteam') }}</title>
<meta name="description" content="{{ __('Агентство Oneteam: большой выбор жилой и коммерческой недвижимости. Алания и другие регионы Турции. Рассрочка и ипотека. Помощь с оформлением.') }}" />
@endsection
