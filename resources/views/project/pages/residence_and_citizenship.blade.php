...
<section class="about">
    <div class="about__content maxContainer">
        ...
        <p class="about__text-desc desc desc_transparent" style="margin-bottom: 20px;">
            Турция является одной из самых популярных для переезда стран, и вызвано это простотой процедуры получения вида на жительство, а впоследствии — и гражданства. О том, как получить турецкий паспорт за покупку недвижимости, расскажет наш сотрудник Никита Новиков, который вот уже 6 лет помогает россиянам натурализоваться в стране через приобретение жилых (и коммерческих) объектов.
